...
export function ArticleReader({ article }: { article: Article }) {
  return (
    ...
    >
      ...
      <div className="prose prose-neutral max-w-none text-foreground prose-headings:scroll-mt-8 prose-headings:font-semibold prose-headings:tracking-tight prose-p:leading-8 prose-a:text-accent prose-a:decoration-border hover:prose-a:decoration-accent prose-blockquote:border-accent/40 prose-blockquote:font-normal prose-blockquote:text-muted-foreground prose-strong:text-foreground prose-code:rounded-sm prose-code:bg-muted prose-code:px-1 prose-code:py-0.5 prose-code:font-mono prose-code:font-normal prose-code:before:content-none prose-code:after:content-none prose-pre:border prose-pre:bg-muted/60 prose-pre:text-foreground prose-pre:shadow-none prose-pre:[&_code]:bg-transparent prose-pre:[&_code]:p-0 prose-li:leading-8 prose-img:rounded-lg">
        <Markdown
